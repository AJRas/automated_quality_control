...
#---pulling array from text file---Begin
txt_file_to_array(0, 719, 0, 982, "Adorable_Kitten_L", filter_array_L)
txt_file_to_array(0, 719, 0, 982, "Adorable_Kitten_H", filter_array_H)
#---pulling array from text file---End

comparison_picture_input = defects[2] #Has to be a string

im4 = Image.open(comparison_picture_input) #defects[2] originally
Picture_to_Array(im4, picture_array3)
im4.close()
def_im = Image.open(comparison_picture_input) #defects[2] originally
...
print("filter pass difference for ", comparison_picture_input, ": ", defect_filter_pass)
